...
async function start() {
    const IGNORE = ["DROID_RAID_LAUNCHED","DROIDS_CHARGING","DROID_DISPENSED_ETHER","JEWEL_COLLECTED","CIVILIAN_LEVEL_UP","CIVILIANS_SYNTHESIS_FINISHED","RESOURCE_CLAIM_VALIDATED","DROIDS_BUILT","DROIDS_POWERED","CIVILIANS_SYNTHESIS_STARTED","JEWEL_CRAFTED","DROIDS_DEPOWERED","DROIDS_RELOCATE_STARTED","DROIDS_RELOCATED","ETHER_CLAIMED","ESSENCE_GENERATED"];
